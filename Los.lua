...
-- Button to collect 500000 Ethereal Orbs continuously
GlitchTab:CreateButton({
    Name = "Start Ethereal Orb (500000 Iterations)",
    Callback = function()
        local count = 0
        ...
        Rayfield:Notify({
            Title = "500000 Ethereal Orbs Collected",
            Content = "Successfully collected 500000 Ethereal Orbs!",
            Duration = 3
        })
    end
})

-- Button to collect 500000 Yellow Orbs continuously
GlitchTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({
            ...
            Content = "Successfully collected 500000Yellow Orbs!",
            Duration = 3
        })
    end
})

-- Button to collect 500000 Red Orbs continuously
GlitchTab:CreateButton({
    Name = "Start Red Orb (500000 Iterations)",
    Callback = function()
        local count = 0
        while count < 500000 do
            local args = {
        ...
        Rayfield:Notify({
            Title = "500000 Red Orbs Collected",
            Content = "Successfully collected 500000 Red Orbs!",
            Duration = 3
        })
    end
})
